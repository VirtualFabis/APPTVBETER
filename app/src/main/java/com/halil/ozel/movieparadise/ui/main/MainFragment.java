...
public class MainFragment extends BrowseFragment implements OnItemViewSelectedListener, OnItemViewClickedListener {
    ...
    private static final int Recientes = 0;
    ...
    private void createDataRows() {
        ...
        movieRowSparseArray.put(Recientes, new MovieRow()
                .setId(Recientes)
    ...
    private void fetchNowPlayingMovies() {
            theMovieDbAPI.getNowPlayingMovies(Config.API_KEY_URL, movieRowSparseArray.get(Recientes).getPage())
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(response -> {
                    bindMovieResponse(response, Recientes);
